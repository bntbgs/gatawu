...
public class formlogin extends javax.swing.JFrame {
            ...
            try {
                ...
                if (sql.next()) {
                    ...
                    if (password.getText().equals(sql.getString("password"))) {
                        ...
                        username.setText("REMOON");
                        password.setText("REMOON123");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        if (JOptionPane.showConfirmDialog(null, "Yakin ingin keluar?", "marvel computer", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            this.setVisible(false);
        }
